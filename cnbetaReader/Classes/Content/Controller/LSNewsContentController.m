...
-(void)initWebView{
    ...
    NSString *html = [NSString stringWithFormat:@"<!DOCTYPE html><html><head><title></title><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no\"/> \
                      ...
                      <script>var config = {enableImage:%@,enableFlashToHtml5:%@};</script> \
                      ...
                      <script src=\"loder.js\"></script></body></html>",@"true",@"true",self.content.title,self.content.source,self.content.time,self.content.hometext,self.content.bodytext];

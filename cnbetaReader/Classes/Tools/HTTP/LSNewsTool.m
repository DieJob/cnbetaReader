...
+(void)loadNewsListWithSuccess:(void (^)(NSArray *))success{
...
+(void)loadMoreNewsListWithSid:(NSString *)sid success:(void (^)(NSArray *))success{
    NSString *timestamp = [NSString getTimestamp];
...
+(void)loadNewsContentWithSid:(NSString *)sid success:(void (^)(LSNewsContent *))success{
...
//        NSLog(@"%@",[[NSString alloc] initWithData:responseObject encoding:NSUTF8StringEncoding]);
        ...
        NSRange range = [el.html rangeOfString:@"<script type=\"text/javascript\" src=\"http://yuntv.letv.com/bcloud.js\">"];
        ...
        if (range.location != NSNotFound) {
            ...
            [bodyText insertString:str atIndex:range.location];
        }
